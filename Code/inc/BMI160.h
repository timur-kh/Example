...
uint8_t BMI160_getMagGyroAcc(int16_t* Xmag, int16_t* Ymag, int16_t* Zmag,
		int16_t* Xgyr, int16_t* Ygyr, int16_t* Zgyr, int16_t* Xacc, int16_t* Yacc, int16_t* Zacc);

/******************************************************Use defines*************************************************/

#define BMI160_WRITE				0xD2
#define BMI160_READ					0xD3
...
#define BMI160_DATA_MAG_X_LSB		0x04
